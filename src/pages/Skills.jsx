...
const Skill = ({card}) => {
  ...
  return(
        <motion.div
          ...
          animate={control} 
        >
          <div className='text-black rounded-full p-3 md:p-4 bg-gradient-to-r from-primary-0 to-tertiary-0 text-xs hover:bg-primary-0 duration-300 hover:border-white border border-black transition font-semibold md:text-lg  w-fit uppercase' >
            {card}
          </div>
        </motion.div> 
  )
