...
const Contact = () => {
  return (
    <div id="contact" className="w-full mx-auto bg-bg3">
        ...
        >
          <div className=" grid md:grid-cols-2 gap-4 w-full py-2">
            <div className=" flex flex-col">
              <label className="uppercase text-base font-semibold py-2">
                Name
              </label>
              <input
          ...
          <div className=" flex flex-row justify-center items-center">
            <button className=" bg-gradient-to-r from-primary-0 to-amber-300 mt-4 w-6/12  p-4 rounded-lg text-white font-semibold">
              {" "}
              Send Message{" "}
            </button>
          </div>
